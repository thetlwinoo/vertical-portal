...
@Component({
  selector: 'app-web-image-type-add',
  templateUrl: './web-image-type-add.component.html',
  styleUrls: ['./web-image-type-add.component.scss']
})
export class WebImageTypeAddComponent implements OnInit, OnDestroy {
  isSaving = false;
  loading = false;
