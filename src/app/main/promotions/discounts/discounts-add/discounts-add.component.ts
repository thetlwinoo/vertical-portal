...
import { DiscountsService, SuppliersService, DiscountTypesService } from '@vertical/services';
import { ActivatedRoute } from '@angular/router';
import { IDiscounts, Discounts, ISuppliers, IDiscountTypes } from '@vertical/models';
...
@Component({
  ...
  styleUrls: ['./discounts-add.component.scss']
})
export class DiscountsAddComponent implements OnInit, OnDestroy {
  isSaving = false;
  loading = false;
