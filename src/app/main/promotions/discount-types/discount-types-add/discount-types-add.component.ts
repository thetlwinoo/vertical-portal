...
@Component({
  selector: 'app-discount-types-add',
  templateUrl: './discount-types-add.component.html',
  styleUrls: ['./discount-types-add.component.scss']
})
export class DiscountTypesAddComponent implements OnInit, OnDestroy {
  isSaving = false;
  loading = false;
  ...
  editForm = this.fb.group({
    ...
    shortLabel: [],
    handle: [],
    modifiedDate: [moment(new Date(), DATE_TIME_FORMAT), [Validators.required]],
  });
